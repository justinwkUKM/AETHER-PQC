  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      <button
        ...
        className="flex items-center gap-2 rounded-full focus:outline-none focus:ring-2 focus:ring-[#91a7ff]/50 transition-all duration-200"
      ...
      >
        <div className="relative flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-[#08111f] shadow-md transition-transform duration-200 hover:scale-105 active:scale-95 overflow-hidden">
          {avatarUrl ? (
            ...
            <span className="font-mono text-xs font-semibold tracking-wider text-[#91a7ff]">
              {initials || "AO"}
            </span>
          )}
          {/* Subtle online badge */}
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex items-center gap-3.5 px-3 py-3 border-b border-white/5">
              <div className="flex h-12 w-12 items-center justify-center rounded-full border border-[#91a7ff]/20 bg-[#0b172a] overflow-hidden">
                {avatarUrl ? (
                  <div
                    className="h-full w-full bg-cover bg-center"
                    role="img"
                  ...
                  <span className="font-mono text-sm font-semibold text-[#91a7ff]">{initials}</span>
                )}
              </div>
