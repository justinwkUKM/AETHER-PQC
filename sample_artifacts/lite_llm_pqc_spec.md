...
* **Purpose**: Serves as the central gateway intercepting PayNet Client API calls (PayNet GPT, PayNet Code) and routing requests down to inference engines.
