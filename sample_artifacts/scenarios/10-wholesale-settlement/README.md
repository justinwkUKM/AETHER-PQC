...
Public research basis: Inspired by public central-bank operational material describing Wholesale Settlement Rail as a multi-currency real-time gross settlement system for interbank funds transfer and securities settlement.
...
Artifacts should test whether the scanner can prioritize non-public but critical settlement infrastructure using topology, business process, participant gateway, and recovery-site context.

## Expected Top Findings

- RSA-2048 participant terminal certificate
- ECDSA-P256 settlement message signing
